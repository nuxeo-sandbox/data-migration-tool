package org.nuxeo.migration.test.operation.document.schema;
...
import org.nuxeo.migration.operation.document.schema.SchemasCopyOperation;
...
public class TestSchemasCopyOperation {
...
//        DocumentModel doc = (DocumentModel) automationService.run(ctx, SchemasCopyOperation.ID);
//        assertEquals("/", doc.getPathAsString());
     ...
     * automationService.run(ctx, SchemasCopyOperation.ID, params);
