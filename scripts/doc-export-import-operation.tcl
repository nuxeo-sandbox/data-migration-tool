...
proc usage {} {
	puts "Usage:"
	puts "tclsh doc-export-import-operation.tcl -sUser xx -sPw xx -sBaseUrl xx -sBaseUrlImport xx -id xx -idFile <filename> -blocksize <size> offset <offset> -maxids <maxids>"
}
...
set sProcessedIdsFileName "export-import-processed-ids-$tStartJob.txt"
set hProcessedIdsFile [open "$sProcessedIdsFileName" "w"]

set sBaseUrl "http://localhost:8080/"
set sBaseUrlImport "http://localhost:9080/"
...
proc export { id } {
	...
	append sCurlCommand { } $sBaseUrl {nuxeo/api/v1/automation/Document.ExportOperation} 
...
proc importDoc { id } {
	...
	## append sCurlCommand $sDentry
	append sCurlCommand { } $sBaseUrlImport {nuxeo/api/v1/automation/Document.ImportOperation} 
